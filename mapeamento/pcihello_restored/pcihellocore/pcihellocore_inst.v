	pcihellocore u0 (
		...
		.hexport_left_external_connection_export (<connected-to-hexport_left_external_connection_export>), // hexport_left_external_connection.export
		.ex_green_led_external_connection_export (<connected-to-ex_green_led_external_connection_export>), // ex_green_led_external_connection.export
		.ex_red_led_external_connection_export   (<connected-to-ex_red_led_external_connection_export>),   //   ex_red_led_external_connection.export
		.in_bottoms_external_connection_export   (<connected-to-in_bottoms_external_connection_export>)    //   in_bottoms_external_connection.export
	);
